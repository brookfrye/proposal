...
Level I is excluded because it can function as an entry/trainee tier, while Council web roles generally require independent delivery and ongoing application ownership.
...
```{r}
  ...
  cst_range_sub[, `Level (City)` := data.table::fcase(
    asg_lvl == "11", "Level II (11)",
    asg_lvl == "111", "Level III (111)",
    default = asg_lvl
  )]
